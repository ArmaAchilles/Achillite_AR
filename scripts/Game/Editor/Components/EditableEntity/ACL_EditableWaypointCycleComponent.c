...
class ACL_EditableWaypointCycleComponentClass: SCR_EditableWaypointComponentClass
{
};
...
*/
class ACL_EditableWaypointCycleComponent : SCR_EditableWaypointComponent
{	
